...
# Läs in båda filerna
df_high = pd.read_csv("highcharts_uppdatering_mattider_S.txt")
df_echart = pd.read_csv("echart_uppdatering_mattider_S.txt")
...
ax.set_title('Uppdateringstid: Highcharts vs ECharts litet dataset\nMedelvärde med standardavvikelse')
